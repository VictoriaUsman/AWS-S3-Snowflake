CREATE DATABASE AWS_IanTristan_Project;

USE DATABASE AWS_IanTristan_Project;
...
create or replace storage integration s3_int
  ...
  storage_provider = s3
  enabled = true
  storage_aws_role_arn = 'arn:aws:iam::294069345505:role/awsToSnowFlakebyIan'
  storage_allowed_locations = ('s3://iantristan-weatherbucket/snowflake/');
...
create or replace stage ext_csv_stage
  URL = 's3://iantristan-weatherbucket/snowflake/'
